...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 29, 2019 lúc 08:26 AM
...
--
-- Cấu trúc bảng cho bảng `banners_lang`
--
...
INSERT INTO `categories` (`id`, `dept_id`, `slug`, `status`, `author`, `created_at`, `updated_at`) VALUES
(1, 1, 'Khác', 1, 1, '2019-03-29 00:00:00', '2019-05-02 01:33:38'),
(2, 1, 'tin-giao-vu', 1, 1, '2019-03-29 00:00:00', '2019-03-29 00:00:00'),
(3, 1, 'tin-nckh-serminar', 1, 1, '2019-03-29 00:00:00', '2019-03-29 00:00:00'),
(4, 1, 'tin-cb-vc-khoa', 1, 1, '2019-03-29 00:00:00', '2019-03-29 00:00:00'),
(5, 1, 'tin-tuyen-dung', 1, 1, '2019-03-29 00:00:00', '2019-05-01 09:27:41'),
(6, 2, 'Khác', 1, 1, '2019-03-29 00:00:00', '2019-05-02 01:33:38'),
(7, 2, 'tin-giao-vu', 1, 1, '2019-03-29 00:00:00', '2019-03-29 00:00:00'),
(8, 2, 'tin-nckh-serminar', 1, 1, '2019-03-29 00:00:00', '2019-03-29 00:00:00'),
(9, 2, 'tin-cb-vc-khoa', 1, 1, '2019-03-29 00:00:00', '2019-03-29 00:00:00'),
(10, 2, 'tin-tuyen-dung', 1, 1, '2019-03-29 00:00:00', '2019-05-01 09:27:41');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `categories_lang`
--
...
--
-- Đang đổ dữ liệu cho bảng `categories_lang`
--

INSERT INTO `categories_lang` (`id`, `cat_id`, `lang_id`, `name`, `description`) VALUES
(1, 1, 1, 'Khác', NULL),
(2, 1, 2, 'Other', NULL),
(3, 2, 1, 'Tin giáo vụ', NULL),
(4, 2, 2, 'Tin giáo vụ', NULL),
(5, 3, 1, 'Tin NCKH - Serminar', NULL),
(6, 3, 2, 'Tin NCKH - Serminar', NULL),
...
(11, 6, 1, 'Khác', NULL),
(12, 6, 2, 'Other', NULL),
(13, 7, 1, 'Tin giáo vụ', NULL),
(14, 7, 2, 'Tin giáo vụ', NULL),
(15, 8, 1, 'Tin NCKH - Serminar', NULL),
(16, 8, 2, 'Tin NCKH - Serminar', NULL),
(17, 9, 1, 'Tin CB - VC Khoa', NULL),
(18, 9, 2, 'Tin CB - VC Khoa', NULL),
(19, 10, 1, 'Tin Tuyển Dụng', NULL),
(20, 10, 2, 'Tin Tuyển Dụng', NULL);
...
--
-- Cấu trúc bảng cho bảng `departments_lang`
--
...
(1, 'Tiếng Việt', 'VIE', '/language_file/vie', 'vietnam.png', 1, 1, '2019-03-15 23:06:18', '2019-03-15 23:06:18'),
(2, 'English', 'ENG', '/language_file/eng', 'vietnam.png', 1, 0, '2019-03-15 23:06:18', '2019-03-15 23:06:18');
...
CREATE TABLE `notification` (
  ...
  `viewed` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Cấu trúc bảng cho bảng `pages_lang`
--
...
(1, 'c', 2, 1, '/uploads/khoa-vat-ly/logo96x96.png', 1, 1, '2019-09-08 09:58:00', '2019-09-08 09:58:40', '2019-09-08 09:58:40', 0),
(2, 'aaaaaaaaaaaaaaaaa', 2, 1, '', 1, 1, '2019-09-29 11:19:00', '2019-09-29 11:20:05', '2019-09-29 11:20:05', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `posts_lang`
--
...
--
-- Đang đổ dữ liệu cho bảng `posts_lang`
--

INSERT INTO `posts_lang` (`id`, `post_id`, `lang_id`, `title`, `content`, `excerpt`) VALUES
(1, 1, 1, 'A', '<p>E</p>\r\n', 'B'),
(2, 1, 2, 'C', '<p>F</p>\r\n', 'D'),
(3, 2, 1, 'DDD', '<p>BBBBBBBBBBBBB</p>\r\n\r\n<div id=\"gtx-trans\" style=\"left:-160px; position:absolute; top:-6px\">\r\n<div class=\"gtx-trans-icon\">&nbsp;</div>\r\n</div>\r\n', 'VVVVVVVV'),
(4, 2, 2, 'AAAAAAAAAAAAAAAAA', '<p>RRRRRRRRRRRRRRRRRRR</p>\r\n', 'VVVVVVVVVVVV');
...
(2, 'Vật Lý - Vật Lý Kỷ Thuật', 'vltk_admin', '$2y$08$VnREYVZaM0NQUHZJMWc5SObqJCfyGQM/awHdZa6RAYy75y7L5VFPO', 'vlth@hcmus.edu.vn', '0982132132', NULL, 2, 1, '[\"1\"]', 1, '2019-09-29 10:24:32', '2019-09-29 10:26:56'),
(4, 'Vật Lý Tin Học', 'vlth_admin', '$2y$08$TE1pQXV5aUtoTWhWU1Uve.ftgobWQHVygVasTmqknkfljSGh9HcFa', 'vlth_admin@hcmus.edu.vn', '0985165464', NULL, 2, 2, '[\"2\"]', 1, '2019-09-29 12:21:13', '2019-09-29 12:21:13');
...
--
-- Chỉ mục cho bảng `categories_lang`
--
...
--
-- Chỉ mục cho bảng `departments_lang`
--
ALTER TABLE `departments_lang`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT cho bảng `banners_lang`
--
ALTER TABLE `banners_lang`
...
--
-- AUTO_INCREMENT cho bảng `departments_lang`
--
ALTER TABLE `departments_lang`
...
--
-- AUTO_INCREMENT cho bảng `pages_lang`
--
ALTER TABLE `pages_lang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `posts_lang`
--
ALTER TABLE `posts_lang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
