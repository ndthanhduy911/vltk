        ...
        <div class="slick-carousel carousel-autoplay pv-20">
            ...
            <div class="col-md-4">
                <div class="image-box team-member shadow-2 mb-20">
                    <div class="overlay-container rounded overlay-visible">
                        <img src="<?= $this->helper->getLinkImage($staff->image, '/assets/frontend/images/education-4.jpg') ?>" alt="<?= $staff->name ?>">
        ...
        <div class="slick-carousel carousel-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="ph-20 feature-box text-center object-non-visible" data-animation-effect="fadeInDownSmall"
                    ...
                    <span class="icon large circle"><img class="rounded-circle" alt="<?= $partner->name ?>" src="<?= $this->helper->getLinkImage($staff->image, '/assets/frontend/images/beauty-1.jpg') ?>"></span>
                    <h3><?= $partner->name ?></h3>
                </div>
            </div>
            <?php } ?>
