...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <?php } ?>"><a class="app-menu__item" href="#" data-toggle="treeview"><i
            ...
            <ul class="treeview-menu">
                <li><a class="treeview-item <?php if ($this->dispatcher->getControllerName() == 'posts' && ($this->isIncluded($this->dispatcher->getActionName(), ['index', 'edit']))) { ?> <?= 'actived' ?> <?php } ?>" href="<?= $this->config->application->backendUri ?>/posts"><i
                        ...
                        Tất cả</a></li>
                <li><a class="treeview-item <?php if ($this->dispatcher->getControllerName() == 'posts' && ($this->isIncluded($this->dispatcher->getActionName(), ['add']))) { ?> <?= 'actived' ?> <?php } ?>" href="<?= $this->config->application->backendUri ?>/posts/add"><i
                        class="icon fa fa-circle-o"></i>
                        Bài viết mới</a></li>
        ...
        <li class="treeview <?php if ($this->isIncluded($this->dispatcher->getControllerName(), ['pages'])) { ?> <?= 'is-expanded' ?><?php } ?>"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                    ...
                    class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item <?php if ($this->dispatcher->getControllerName() == 'pages' && ($this->isIncluded($this->dispatcher->getActionName(), ['index', 'edit']))) { ?> <?= 'actived' ?> <?php } ?>" href="<?= $this->config->application->backendUri ?>/pages"><i class="icon fa fa-circle-o"></i> Danh sách</a></li>
                <li><a class="treeview-item <?php if ($this->dispatcher->getControllerName() == 'pages' && ($this->isIncluded($this->dispatcher->getActionName(), ['add']))) { ?> <?= 'actived' ?> <?php } ?>" href="<?= $this->config->application->backendUri ?>/pages/add"><i class="icon fa fa-circle-o"></i> Trang mới</a></li>
            </ul>
        </li>
        ...
        <li class="treeview <?php if ($this->isIncluded($this->dispatcher->getControllerName(), ['users', 'roles'])) { ?> <?= 'is-expanded' ?>
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item <?php if ($this->dispatcher->getControllerName() == 'users' && ($this->isIncluded($this->dispatcher->getActionName(), ['add']))) { ?> <?= 'actived' ?> <?php } ?>"
