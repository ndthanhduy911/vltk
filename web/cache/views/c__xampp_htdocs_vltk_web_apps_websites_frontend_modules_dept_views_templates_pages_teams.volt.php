    ...
    <div class="container">
        <div class="row">
            <div class="main col-md-9">
                <h3 class="text-primary"><?= $this->ml->_ml_system('main_staff', 'BAN CHỦ NHIỆM') ?></h3>
                <div class="separator-2"></div>
                <?php if ($dept_id == 1) { ?>
                    <div class="row grid-space-10">
                        <?php foreach ($deanStaffs as $staff) { ?>
                        <div class="col-md-4">
                            <div class="team-member image-box style-2 dark-bg text-center">
                                <div class="overlay-container overlay-visible">
                                    <img src="<?= $this->helper->getLinkImage($staff->featured_image, '/assets/frontend/images/team-member-1.jpg') ?>" alt="<?= $staff->title ?>" width="100%">
                                </div>
                                <div class="body">
                ...
                <?php if ($dept_id == 1) { ?>
                    <?php $dept_o_id = 0; ?>
                    <?php foreach ($otherStaffs as $key => $staff) { ?>
                        <?php if ($dept_o_id != $staff->dept_id) { ?>
                            <h3 class="text-primary text-uppercase"><?= $this->ml->_ml_system('subject', 'Bộ môn') ?> <?= Departments::getTitleById($staff->dept_id, $lang_id) ?></h3>
                            <div class="separator-2"></div>
                            <div class="w-100">
                        <?php } ?>
