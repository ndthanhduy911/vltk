        ...
        <div class="container">
            <div class="footer-inner">
                <div class="row">
                    ...
                    <!-- <div class="col-lg-3">
                        <div class="footer-content">
                            <h4 class="title text-default"><i class="fa fa-child pr-10"></i> <?= $this->ml->_ml_system('student', 'Sinh viên') ?></h4>
                            <nav class="mb-20">
                                <ul class="nav flex-column list-style-icons">
                                    <li class="nav-item"><a class="nav-link" href="components-buttons.html"><i
                                                class="fa fa-chevron-circle-right"></i>
                    ...
                    <div class="col-lg-3">
                        <div class="footer-content">
                            <h4 class="title text-default"><i class="fa fa-institution pr-10"></i> <?= $this->ml->_ml_system('school', 'Đại học') ?></h4>
                            <nav class="mb-20">
                                <ul class="nav flex-column list-style-icons">
                                    <li class="nav-item"><a class="nav-link" href="components-buttons.html"><i
                                                class="fa fa-chevron-circle-right"></i>
