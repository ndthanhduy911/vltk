                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <select id="menuLocationId" class="form-control" name="menu_location_id">
                                ...
                                <?php foreach ($menu_location as $location) { ?> <option value="<?= $location->id ?>"><?= $location->name ?></option> <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-6 text-right">
                            <a id="addMenu" href="<?= $this->config->application->backendUri ?>/menu/update" title="Tạo" class="btn btn-success fa fa-plus"></a>
                        </div>
                    </div>
                </div>
                <div class="tile-body">
