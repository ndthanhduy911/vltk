...
<body class=" ">
                                ...
                                <nav>
                                    <ul class="list-inline">
                                        <li class="list-inline-item"><a class="link-light mr-1 " href="#"><i
                                                    class="fa fa-users pr-1"></i>Alumni</a></li>
                                        <li class="list-inline-item"><a class="link-light mr-1 " href="#"><i
                                                    class="fa fa-user pr-1"></i>Staff/Faculty</a></li>
                                        <li class="list-inline-item"><a class="link-light mr-1 " href="#"><i
                                                    class="fa fa-child pr-1"></i>Students</a></li>
                                        <li class="list-inline-item hidden-md-down"><a class="link-light mr-1"
                                                href="#"><i class="fa fa-flask pr-1"></i>Researches</a></li>
                                        <li class="list-inline-item hidden-md-down"><a class="link-light mr-1"
                                                href="#"><i class="fa fa-info-circle pr-1"></i>Information</a></li>
                                        <li class="list-inline-item hidden-md-down"><strong class="pl-1">Call
                                                Us:</strong>
                                            +12 123 123 123
                                        </li>
                                    </ul>
                    ...
                    <div class="row">
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                            ...
                                            <ul class="navbar-nav ml-xl-auto">
                                                ...
                                                <li class="nav-item dropdown ">
                                                    <a href="portfolio-grid-2-3-col.html"
                        ...
                        <div class="col-auto hidden-md-down pl-0 pl-md-1">
                            ...
                            <div class="header-dropdown-buttons">
                                <a href="page-contact.html" class="btn btn-sm hidden-xs btn-default">Liên hệ <i
            ...
            <div class="container">
                <div class="row justify-content-lg-center">
                    ...
                    <div class="main col-lg-6 pv-40">
                        ...
                        <p class="lead">The requested URL was not found on this server. Make sure that the Web site
                            address displayed in the address bar of your browser is spelled and formatted correctly.</p>
                        <form role="search">
                                ...
                                <div class="footer-content">
                                    ...
                                    <div class="media-wrap">
                                        <a href="https://mobirise.com/">
                                            <img src="/assets/frontend/images/logo-khoa-single-1-96x96.png "
                                                title=" Khoa">
                                        </a>
                                    </div>
                                    ...
                                    <nav class="mb-20">
                                        <ul class="nav flex-column list-style-icons">
                                            <li class="nav-item"><a class="nav-link"
                                                    href="components-social-icons.html"><i
                                    ...
                                    <nav class="mb-20">
                                        <ul class="nav flex-column list-style-icons">
                                            <li class="nav-item"><a class="nav-link" href="components-buttons.html"><i
                                                    ...
                                                    Cựu sinh viên</a></li>
                                            <li class="nav-item"><a class="nav-link"
                                                    href="components-tabs-and-pills.html"><i
                                                        class="fa fa-chevron-circle-right"></i>
    ...
    <!-- Appear javascript -->
    <script src="/assets/frontend/plugins/waypoints/jquery.waypoints.min.js"></script>
    <script src="/assets/frontend/plugins/waypoints/sticky.min.js"></script>
    <!-- Count To javascript -->
