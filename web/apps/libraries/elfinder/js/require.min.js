...
! function (global, setTimeout) {
    ...
    function newContext(e) {
        ...
        function v() {
            ...
            for (d(); O.length;) {
                ...
                if (null === (e = O.shift())[0]) return false;
                h(e)
            }
            q.defQueueMap = {}
        }
    ...
    if (void 0 === define) {
        ...
        void 0 === require || isFunction(require) || (cfg = require, require = void 0), req = requirejs = function (e, t, i, r) {
            ...
            if (head || (head = e.parentNode), dataMain = '/elfinder/main.js') return mainScript = dataMain, cfg.baseUrl || -1 !== mainScript.indexOf("!") || (src = mainScript.split("/"), mainScript = src.pop(), subPath = src.length ? src.join("/") + "/" : "./", cfg.baseUrl = subPath), mainScript = mainScript.replace(jsSuffixRegExp, ""), req.jsExtRegExp.test(mainScript) && (mainScript = dataMain), cfg.deps = cfg.deps ? cfg.deps.concat(mainScript) : [mainScript], !0
