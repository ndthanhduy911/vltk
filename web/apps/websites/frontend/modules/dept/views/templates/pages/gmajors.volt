...
<div class="banner dark-translucent-bg fixed-bg"
    style="background-image:url('{{helper.getLinkImage(page.bgimage, '/assets/frontend/images/banner-page.jpg') }}'); background-position: 50% 27%;">
    <div class="container">
                    ...
                    <div class="col-md-6 isotope-item">
                        <div class="image-box shadow-2 bordered text-center mb-20">
                            <div class="overlay-container rounded overlay-visible">
                                <img src="{{ helper.getLinkImage(gmajor.image,'/assets/frontend/images/default2.jpg') }}"
                                    alt="{{ dept_item.title }}">
