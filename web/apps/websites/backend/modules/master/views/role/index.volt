                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-header p-0 border-bottom-0">
                                <ul class="nav nav-tabs w-100" id="roleTabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="dataFiledTab" data-toggle="pill" href="#dataFiled"
                                            role="tab" aria-controls="dataFiled" aria-selected="false">Thông tin</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="dashboardTab" data-toggle="pill" href="#dashboard"
                                            role="tab" aria-controls="dashboard" aria-selected="false">Bảng điều
                                            khiển</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="notificationTab" data-toggle="pill" href="#notification"
                                            role="tab" aria-controls="notification" aria-selected="false">Thông báo</a>
                                    </li>
                                    <button type="submit"
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="roleTabsContent">
                                    ...
                                    <div class="tab-pane fade" id="dataFiled" role="tabpanel"
                                        aria-labelledby="dataFiledTab">
                                        <div class="card">
                                            <div class="card-header pl-3 pr-3 align-items-center d-flex align-items-center">
                                                <h3 class="card-title d-flex align-items-center"><input class="mr-1" type="checkbox" id="assetSelectAll" value="1">Tài sản</h3>
                                            ...
                                            <div class="card-body p-3">
                                                <div class="row">
                                                <?php $groups = \FieldGroup::filedGroup('asset'); 
                                                foreach ($groups as $value) { ?>
                                                <div class="col-md-4 col-lg-3 mb-0">
                                                    <div class="form-group mt-0">
                                                        <div class="custom-control d-flex align-items-center pl-0">
                                                            <input class="" type="checkbox" id="asset-{{value}}"
                                                                name="asset[]" value="{{value}}">
                                                            <label for="asset-{{value}}"
                                                                class="font-weight-normal mb-0 ml-2"><?= \Asset::filedName($value) ?></label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php } ?>
                                        ...
                                        <div class="card">
                                            <div class="card-header pl-3 pr-3 align-items-center d-flex align-items-center">
                                                <h3 class="card-title d-flex align-items-center"><input class="mr-1" type="checkbox" id="inventorySelectAll" value="1">Kiểm kê Tài sản</h3>
                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                                                </div>
                                            </div>
                                            <div class="card-body p-3">
                                                <div class="row">
                                                <?php $groups = \FieldGroup::filedGroup('inventory');  
                                                foreach ($groups as $value) { ?>
                                                <div class="col-md-4 col-lg-3 mb-0">
                                                    <div class="form-group mt-0">
                                                        <div class="custom-control d-flex align-items-center pl-0">
                                                            <input class="" type="checkbox" id="inventory-{{value}}"
                                                                name="inventory[]" value="{{value}}">
                                                            <label for="inventory-{{value}}"
                                                                class="font-weight-normal mb-0 ml-2"><?= \Asset::filedName($value) ?></label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header pl-3 pr-3 align-items-center d-flex align-items-center">
                                                <h3 class="card-title d-flex align-items-center"><input class="mr-1" type="checkbox" id="estimateSelectAll" value="1">Đánh giá Tài sản</h3>
                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                                                </div>
                                            </div>
                                            <div class="card-body p-3">
                                                <div class="row">
                                                <?php $groups = \FieldGroup::filedGroup('estimate');  
                                                foreach ($groups as $value) { ?>
                                                <div class="col-md-4 col-lg-3 mb-0">
                                                    <div class="form-group mt-0">
                                                        <div class="custom-control d-flex align-items-center pl-0">
                                                            <input class="" type="checkbox" id="estimate-{{value}}"
                                                                name="estimate[]" value="{{value}}">
                                        ...
                                        <div class="card">
                                            <div class="card-header pl-3 pr-3 align-items-center d-flex align-items-center">
                                                <h3 class="card-title">Ghi giảm Tài sản</h3>
                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                                                </div>
                                            </div>
                                            <div class="card-body p-3">
                                                <div class="row">
                                                <?php $groups = \FieldGroup::filedGroup('reduction');  
                                                foreach ($groups as $value) { ?>
                                                <div class="col-md-4 col-lg-3 mb-0">
                                                    <div class="form-group mt-0">
                                                        <div class="custom-control d-flex align-items-center pl-0">
                                                            <input class="" type="checkbox" id="reduction-{{value}}"
                                                                name="reduction[]" value="{{value}}">
                                                            <label for="reduction-{{value}}"
                                                                class="font-weight-normal mb-0 ml-2"><?= \Asset::filedName($value) ?></label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header pl-3 pr-3 align-items-center d-flex align-items-center">
                                                <h3 class="card-title d-flex align-items-center"><input class="mr-1" type="checkbox" id="pcplanSelectAll" value="1">Kế hoạch mua sắm</h3>
                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                                                </div>
                                            </div>
                                            <div class="card-body p-3">
                                                <div class="row">
                                                <?php $groups = \FieldGroup::filedGroup('pcplan');  
                                                foreach ($groups as $value) { ?>
                                                <div class="col-md-4 col-lg-3 mb-0">
                                                    <div class="form-group mt-0">
                                                        <div class="custom-control d-flex align-items-center pl-0">
                                                            <input class="" type="checkbox" id="pcplan-{{value}}"
                                                                name="pcplan[]" value="{{value}}">
                                                            <label for="pcplan-{{value}}"
                                                                class="font-weight-normal mb-0 ml-2"><?= \Asset::filedName($value) ?></label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header pl-3 pr-3 align-items-center d-flex align-items-center">
                                                <h3 class="card-title d-flex align-items-center"><input class="mr-1" type="checkbox" id="furnishSelectAll" value="1">Đề nghị trang cấp</h3>
                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                                                </div>
                                            </div>
                                            <div class="card-body p-3">
                                                <div class="row">
                                                <?php $groups = \FieldGroup::filedGroup('furnish');  
                                                foreach ($groups as $value) { ?>
                                                <div class="col-md-4 col-lg-3 mb-0">
                                                    <div class="form-group mt-0">
                                                        <div class="custom-control d-flex align-items-center pl-0">
                                                            <input class="" type="checkbox" id="furnish-{{value}}"
                                                                name="furnish[]" value="{{value}}">
                                                            <label for="furnish-{{value}}"
                                                                class="font-weight-normal mb-0 ml-2"><?= \Asset::filedName($value) ?></label>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="dashboard" role="tabpanel"
                                        ...
                                        <div class="row" id="dashboardGroup">
                                            {% for dashboard in dashboards %}
                                            <div class="col-md-6 col-lg-3 mb-0">
                                                <div class="form-group mt-0">
                                                    <div class="custom-control d-flex align-items-center pl-0">
                                                        <input class="" type="checkbox" id="dashboard{{dashboard.id}}"
                                                            name="dashboards[]" value="{{dashboard.id}}">
                                                        <label for="dashboard{{dashboard.id}}"
                                                            class="font-weight-normal mb-0 ml-2">{{dashboard.name}}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            {% endfor  %}
