                    ...
                    <div class="bs-component bg-white rounded">
                        ...
                        <div class="tab-content p-3">
                            <div class="tab-pane fade active show" id="banner">
                                <form class="col-md-12 p-0" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form" action="{{ config.application.backendUri }}/home/update/1">
                            ...
                            <div class="tab-pane fade" id="posts">
                                <form class="col-md-12 p-0" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form" action="{{ config.application.backendUri }}/home/update/2">
                                    <ul class="nav nav-tabs">
                            ...
                            <div class="tab-pane fade" id="depts">
                                <form class="col-md-12 p-0" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form" action="{{ config.application.backendUri }}/home/update/3">
                                    <ul class="nav nav-tabs">
                            ...
                            <div class="tab-pane fade" id="staffs">
                                <form class="col-md-12 p-0" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form" action="{{ config.application.backendUri }}/home/update/4">
                                    <ul class="nav nav-tabs">
                            ...
                            <div class="tab-pane fade" id="partners">
                                <form class="col-md-12 p-0" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form" action="{{ config.application.backendUri }}/home/update/5">
                                    <ul class="nav nav-tabs">
                            ...
                            <div class="tab-pane fade" id="contacts">
                                <form class="col-md-12 p-0" method="POST" enctype="multipart/form-data" data-toggle="validator" role="form" action="{{ config.application.backendUri }}/home/update/6">
                                    <ul class="nav nav-tabs">
