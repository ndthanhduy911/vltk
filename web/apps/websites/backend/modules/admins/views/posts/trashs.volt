        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="btn-group float-right">
                    <a id="settingTrashPosts" data-href="<?= WEB_ADMIN_URL ?>/setting/filters" data-get="<?= WEB_ADMIN_URL ?>/setting/getsinglefilter?fkey=trashposts" title="Thiết lập giao diện"
                ...
                {% endif %}
                {% if master.checkPermission('posts', 'restore') %}
                <div class="btn-group float-right">
                    <a id="restorePosts" data-href="<?= WEB_ADMIN_URL ?>/posts/restore" title="Khôi phục bài viết"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        <form action="" id="searchTrashPosts" class="searchForm">
                        ...
                        <div class="table-responsive">
                            <table id="trashposts" class="table table-bordered table-hover rounded">
                                <thead>
                                    <tr>
...
<div class="modal fade" id="modalSettingTrashPosts">
    <div class="modal-dialog" style="min-width: 1300px;">
        <div class="modal-content">
            <form id="frmSettingTrashPosts" action="" method="POST" enctype="multipart/form-data" data-toggle="validator" class="customForm">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="fkey" value="trashposts">
