        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="btn-group float-right">
                    <a id="settingSlideshows" data-href="<?= WEB_ADMIN_URL ?>/setting/filters" data-get="<?= WEB_ADMIN_URL ?>/setting/getsinglefilter?fkey=slideshows" title="Thiết lập giao diện"
                ...
                <div class="btn-group float-right">
                    <a id="addSlideshows" href="<?= WEB_ADMIN_URL ?>/slideshows/view" title="Tạo mới"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        <form action="" id="searchSlideshows" class="searchForm">
                        ...
                        <div class="table-responsive">
                            <table id="slideshows" class="table table-bordered table-hover rounded">
                                <thead>
                                    <tr>
...
<div class="modal fade" id="modalSettingSlideshows">
    <div class="modal-dialog" style="min-width: 1300px;">
        <div class="modal-content">
            <form id="frmSettingSlideshows" action="" method="POST" enctype="multipart/form-data" data-toggle="validator" class="customForm">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="fkey" value="slideshows">
