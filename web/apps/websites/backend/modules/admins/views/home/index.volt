                ...
                <div class="bs-component bg-white rounded">
                    ...
                    <div class="tab-content p-3">
                        ...
                        <div class="tab-pane fade {{ !key ? 'active show' : '' }}"id="lang{{lang.id}}">
                            <h5 class="text-primary font-weight-normal">{{ deptid == 1 ? 'Bộ môn' : 'Hướng nghiên cứu' }}</h5>
            ...
            <div class="col-md-3 pr-0">
                ...
                <div class="tile p-3 mb-3">
                    <div class="row m-0">
                        ...
                        <h5 class="font-weight-bold text-primary w-100">{{ deptid == 1 ? 'Bộ môn' : 'Hướng nghiên cứu' }}</h5>
                        <div class="w-100 mb-3">
                            ...
                            <a id="uploadImageSpecializedBg" href="#" class="link">Đặt ảnh nền {{ deptid == 1 ? 'bộ môn' : 'hướng nghiên cứu' }}</a>
                        </div>
                        ...
                        <div class="w-100 mb-3">
                            ...
                            <a id="uploadImagePartnerBg" href="#" class="link">Đặt ảnh nền {{ deptid == 1 ? 'bộ môn' : 'hướng nghiên cứu' }}</a>
                        </div>
