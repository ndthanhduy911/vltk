<form id="frmBanners" action="<?= WEB_ADMIN_URI ?>/banners/update<?= !empty($page->id) ? '/'.$page->id : '' ?>" method="post" enctype="multipart/form-data" data-toggle="validator" role="form">
            ...
            <div class="row">
                <div class="col-sm-6 d-flex align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= WEB_ADMIN_URL ?>/banners">Bài viết</a></li>
                        <li class="breadcrumb-item active">{{ title }}</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    <div class="float-right">
                        <a id="btnBackPost" href="<?= WEB_ADMIN_URI.'/banners' ?>" class="btn btn-hnn btn-hnn-default" title="Trở về"><span><i class="fas fa-reply"></i></span></a>
                    </div>
                    {% if master.checkPermission('banners', 'update','1') %}
                    <div class="float-right">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group label-floating col-md-12">
                                        <div class="input-group">
                                            <label class="control-label">{{formPage.getLabel('attrid')}}</label>
                                            {{formPage.render('attrid')}}
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="form-group label-floating col-md-12">
