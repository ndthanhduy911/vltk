<main class="app-content">
    <div class="app-title mb-3">
        <div>
            <h1><i class="fa fa-th-list"></i>{{title}} hướng nghiên cứu</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item"><a class="link" href="{{ config.application.backendUri }}"><i class="fa fa-home fa-lg"></i></a></li>
            <li class="breadcrumb-item"><a class="link" href="{{ config.application.backendUri }}/researches">Hướng ngiên cứu</a></li>
        ...
        <form class="col-md-12 row p-0 m-0" method="post" enctype="multipart/form-data" data-toggle="validator"
            ...
            <div class="col-md-3 pr-0">
                ...
                <div class="tile p-3 mb-3">
                    <div class="row m-0">
                        <div class="col-md-12 p-0">
                            <img id="showBackgroundImg" class="w-100 d-block" src="{{ research.background_image ? research.background_image : '' }}"
                                alt="{{ research.background_image ? research.background_image : '' }}">
                            {{form_research.render('background_image')}}
                            <a id="uploadBackgroundImage" href="#" class="link">Đặt ảnh nền</a>
                            <a id="removeBackgroundImage" href="#" class="link text-danger {{ research.background_image ? '' : 'hidden' }}">Xóa</a>
                        </div>
                    </div>
                </div>
            </div>
