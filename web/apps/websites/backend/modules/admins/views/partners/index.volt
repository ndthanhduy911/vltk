        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="btn-group float-right">
                    <a id="settingPartners" data-href="<?= WEB_ADMIN_URL ?>/setting/filters" data-get="<?= WEB_ADMIN_URL ?>/setting/getsinglefilter?fkey=partners" title="Thiết lập giao diện"
                        class="ml-2 btn btn-hnn btn-hnn-default"><span><i class="fas fa-cog"></i></span></a>
                </div>

                {% if master.checkPermission('partners', 'delete') %}
                <div class="btn-group float-right">
                    <a id="deletePartners" data-href="<?= WEB_ADMIN_URL ?>/partners/delete" title="Xóa"
                        class="ml-2 btn btn-hnn btn-hnn-danger"><span><i class="fas fa-trash"></i></span></a>
                </div>
                {% endif %}
                {% if master.checkPermission('partners', 'update') %}
                <div class="btn-group float-right">
                    <a id="addPartners" href="<?= WEB_ADMIN_URL ?>/partners/view" title="Tạo mới"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        <form action="" id="searchPartners" class="searchForm">
                        ...
                        <div class="table-responsive">
                            <table id="partners" class="table table-bordered table-hover rounded">
                                <thead>
                                    <tr>
                                        <th data-col="no" class="align-middle text-center" style="width: 20px;">
                                            <input id="partnersCheckboxAll" type="checkbox" value="1">
                                        </th>
                                        ...
                                        <th data-col="{{table}}" class="align-middle text-center"><?= $this->helper->showSort($table,$this,'partners',\Partners::filedName($table)) ?></th>
                                        {% endfor %}
...
<div class="modal fade" id="modalSettingPartners">
    <div class="modal-dialog" style="min-width: 1300px;">
        <div class="modal-content">
            <form id="frmSettingPartners" action="" method="POST" enctype="multipart/form-data" data-toggle="validator" class="customForm">
                ...
                <div class="modal-body">
                                    ...
                                    <div class="form-group mt-0">
                                        <div class="custom-control d-flex align-items-center pl-0">
                                            ...
                                            <label for="filters-{{value}}"
                                                class="font-weight-normal mb-0 ml-2"><?= \Partners::filedName($value) ?></label>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
                    ...
                    <input type="hidden" name="fkey" value="partners">
