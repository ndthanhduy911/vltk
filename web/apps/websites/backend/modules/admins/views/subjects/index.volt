    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                {% if master.checkPermission('subjects', 'trashs') %}
                <div class="btn-group float-right">
                    <a href="<?= WEB_ADMIN_URL ?>/subjects/trashs" title="Thùng rác"
                        class="ml-2 btn btn-hnn btn-hnn-warning"><span><i class="fas fa-trash"></i></span></a>
                </div>
                {% endif %}
                {% if master.checkPermission('subjects', 'trashs') %}
                <div class="btn-group float-right">
                    <a id="deleteSubjects" data-href="<?= WEB_ADMIN_URL ?>/subjects/trash" title="Xóa"
