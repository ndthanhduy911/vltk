...
class Module implements ModuleDefinitionInterface
{
    ...
    public function registerAutoloaders(\Phalcon\DiInterface $dependencyInjector = null) // <- here it is
    {
        ...
        $loader->registerNamespaces(array(
            'Backend\Modules\Shared\Controllers' => __DIR__ . '/controllers/',
            'Backend\Modules\Shared\Forms' => __DIR__ . '/forms/'
        ));
        $loader->register();
    }
    ...
    public function registerServices(\Phalcon\DiInterface $di)
    {
        ...
        $di->set('dispatcher' , function(){
            ...
            $dispatcher->setDefaultNamespace("Backend\Modules\Shared\Controllers\\");
            return $dispatcher;
        });
