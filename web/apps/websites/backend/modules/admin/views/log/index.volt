...
<div class="row page-titles">
    <div class="col-md-8 align-self-center">
        <h3 class="text-hnn font-weight-bold">QUẢN LÝ LOG QUẢN TRỊ</h3>
        <span>Quản lý các hành động có thay đổi dữ liệu dưới cơ sở dữ liệu cũng như quản lý đăng nhập của các tài khoản quản trị</span>
    </div>
    <div class="col-md-4 align-self-center">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Quản lý log quản trị</li>
        </ol>
    </div>
</div>
                        ...
                        <table id="log" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="align-middle"><?php echo $user_key || $user_key===0? $user[$user_key]['fullname'] : '' ?></td>
