<main class="app-content">
    <div class="app-title mb-3">
        <div>
            <h1><i class="fa fa-th-list"></i> LINKS</h1>
            <p>Quản lý link</p>
        </div>
        ...
        <div class="col-md-12 p-0">
            <div class="tile">
                <div class="col-12 p-0 mb-2">
                    <a id="addLink" href="{{ config.application.backendUri }}/setting/updatelink" title="Tạo" class="btn btn-success fa fa-plus pull-right"></a>
                </div>
                <div class="tile-body">
