                    ...
                    <ul class="products-list product-list-in-card">
                        ...
                        <li class="item">
                            ...
                            <div class="product-info">
                                <a target="_blank" href="<?= Posts::getUrl($dept, $post) ?>" class="product-title">{{ post.title }}<span class="badge badge-info float-right">{{ helper.datetimeVn(post.calendar,'d/m/Y') }}</span></a>
