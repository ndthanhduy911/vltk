	...
	<ul class="app-menu">
		...
		<li class="treeview {% if dispatcher.getControllerName() in ['posts','categories'] %} {{ 'is-expanded' }}{% endif %}">
			...
			<ul class="treeview-menu">
				<li><a class="treeview-item {% if dispatcher.getControllerName()=='posts' AND (dispatcher.getActionName() == 'index' OR (dispatcher.getActionName() == 'update' AND dispatcher.getParam('id'))) %} {{ 'actived' }} {% endif %}" href="{{ config.application.backendUri }}/posts"><i class="icon fa fa-arrow-circle-right"></i>Tất cả</a></li>
				<li><a class="treeview-item {% if dispatcher.getControllerName()=='posts' AND (dispatcher.getActionName() in ['update']) AND !dispatcher.getParam('id') %} {{ 'actived' }} {% endif %}" href="{{ config.application.backendUri }}/posts/update"><i class="icon fa fa-arrow-circle-right"></i>Bài viết mới</a></li>
				<li><a class="treeview-item {% if dispatcher.getControllerName()=='categories' %} {{ 'actived' }} {% endif %}" href="{{ config.application.backendUri }}/categories"><i class="icon fa fa-arrow-circle-right"></i> Danh mục</a></li>
		...
		<li class="treeview {% if dispatcher.getControllerName() in ['subjects','calendars','researches', 'classes'] %} {{ 'is-expanded' }}{% endif %}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label">Đào tạo</span><i class="treeview-indicator fa fa-angle-right"></i></a>
			<ul class="treeview-menu">
				...
				<li><a class="treeview-item {% if dispatcher.getControllerName()=='researches' AND dept_id != 1 %} {{ 'active' }} {% endif %}" href="{{ config.application.backendUri }}/researches"><i class="icon fa fa-arrow-circle-right"></i> Hướng nghiên cứu</a></li>
			</ul>
		</li>
